...
MODEL_INFO = {
        ...
        "keys": ["AMD", "AVGO", "DEXUSEU", "DEXCAUS", "NASDAQCOM", "DGS10", "FEDFUNDS"], #adjust the features here based on what is in the template and the feature we choose, reupload this and then create another streamlit app
        "inputs": [{"name": k, "type": "number", "min": -1.0, "max": 1.0, "default": 0.0, "step": 0.01} for k in ["AMD", "AVGO", "DEXUSEU", "DEXCAUS", "NASDAQCOM", "DGS10", "FEDFUNDS"]]
}
